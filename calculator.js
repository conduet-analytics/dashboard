 ...
 *
 * Functions are global (window scope) so app.js can call them directly.
 */
...
/** CSAT = weighted average of Overall CSAT Score by survey count */
const _csat = (rows) => {
...
/**
 * Split rows by location + emp_status and compute KPIs for each group.
 * @param {Array} rows
 * @returns {Object} { conduet: { total, tenured, new_hires }, hrd: { total } }
 */
